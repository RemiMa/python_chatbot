...
GREETING_INPUTS = ("hello", "hi", "greetings", "sup", "what's up", "hey","bonjour","salut")
GREETING_RESPONSES = ["hi", "hey", "Hello my dear", "hi there", "hello", "I am glad! You are talking to me"]
